  ...
  return (
    <>
      <div id="/about" className={darkMode ? "dark" : ""}>
        <div className="w-full  bg-[#E0E8F6] dark:bg-[#1A1A1A] md:flex justify-center">
          <div className="  md:w-5/6 xl:w-4/6 mx-auto md:gap-16 px-5  md:px-0 inter md:flex md:pt-40 pt-10  ">
            {/* Image */}
            ...
            <div>
              ...
              <div className=" text-lg pt-5 text-[#1C1E53] dark:text-[#E1E1E1] flex flex-col gap-3  text-center">
                <p>
                  ...
                  to helping businesses make informed decisions and stay ahead
                  in today's data-driven world.{" "}
                </p>
                <p>
                  I bring a blend of technical expertise, hands-on experience,
                  and a commitment to clear communication to every project.
                  Whether it's uncovering hidden patterns, predicting future
                  trends, or automating processes with AI, I'm here to help you
